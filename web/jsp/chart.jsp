                    ...
                    <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabSty01"
                        ...
                        <tr>
                            ...
                            <td width="160" height="160" align="center" valign="middle"><span class="imgw"><a href="#"
                                                                                                              target="_blank"><img
                                    src="../images/pro_04.jpg" border="0" width="160"/></a></span>
                            </td>
                            <td><a href="#" target="_blank"><span class="STYLE5">推荐 新疆和田 玉枣 32元 肉厚 相当于昆仑山四星</span></a>
                            </td>
                            <td align="center">￥<span id="000726501">199.00</span></td>
                            <td align="center">
                                <input id="min1" name=""  style=" width:12px; height:14px;border:1px solid #ccc;" type="button" value="-" />
                                <input name="OrderAmount_2" id="OrderAmount_2" maxlength="3"
                                                      style="width: 20px; height: 15px; color: rgb(75, 75, 75);"
                                                      value="1" type="text"/>
                                <input id="add1" name="" style=" width:12px; height:14px;border:1px solid #ccc;" type="button" value="+" />
                            </td>
                            <td align="center">￥<span id="Pdt_price1" style="color:#ff5500;font-size:14px; font-weight:bold;"></span></td>
                        ...
                        <script type="text/javascript">
                            $(function () {
                                ...
                                function setTotal() {
                                    ...
                                    $("#Pdt_price1").html((parseInt(t.val()) * 8).toFixed(2));
                        ...
                        <tr>
                            ...
                            <td height="160" align="center" class="gwcSuit"><span class="imgw"><a href="#"
                                                                                                  target="_blank"><img
                                    src="../images/pro_02.jpg"  border="0" width="160"/></a></span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td height="160" align="center" valign="middle"><span class="imgw"><a href="#"
                                                                                                  target="_blank"><img
                                    src="../images/pro_03.jpg" border="0" width="160"/></a></span>
                            </td>
                            <td><a href="#" target="_blank"><span class="STYLE5">推荐 新疆和田 玉枣 32元 肉厚 相当于昆仑山四星</span></a>
                            </td>
                            <td align="center">￥<span id="000726503">199.00</span></td>
                            <td align="center">
                                <input id="min3" name=""  style=" width:20px; height:18px;border:1px solid #ccc;" type="button" value="-" />
                                <input name="OrderAmount_2" id="OrderAmount_1" maxlength="3"
                                                      onchange="changeSuccess=false;EditProductCount('00072650','1',this)"
                                                      onkeypress=" if((arguments[0] || window.event).keyCode==13){this.blur(); return false;}"
                                                      style="width: 20px; height: 15px; color: rgb(75, 75, 75);"
                                                      value="1" type="text"/>
                                <input id="add3" name="" style=" width:20px; height:18px;border:1px solid #ccc;" type="button" value="+" />
                            </td>
